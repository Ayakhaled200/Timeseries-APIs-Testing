...
test_data_folder = r"E:\Giza Systems\Yara Mahfouz\test_splits"

# Load the CSV that has dataset_id and num_of_values
num_of_values_df = pd.read_csv(
    r"E:\Giza Systems\Yara Mahfouz\meta_data\N_summary.csv")
# Extract the maximum lag from each list in the 'optimal_lags' column
# num_of_values_df['lag'] = num_of_values_df['optimal_lags'].apply(lambda x: max(eval(x)))
...
output_path = r"E:\Giza Systems\Yara Mahfouz\yara_model_performance_report_1000row3.xlsx"
