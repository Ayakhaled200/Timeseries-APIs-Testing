...
test_data_folder = r"E:\Giza Systems\Mariam_Ashraf\pythonProject\test_splits"

# Load the CSV that has dataset_id and num_of_values
data_ids = pd.read_csv(
    r"E:\Giza Systems\Mariam_Ashraf\pythonProject\data_ids.csv")
...
with httpx.Client() as client:
    ...
    for index, row in data_ids.iterrows():
        ...
        # Drop rows with any remaining NaN or None values
        ...
        for i in range(lag, len(df)):
            ...
            if response.status_code == 200:
                ...
                predictions.append(prediction[-1]) #there is mre the 1 prediction at a time, we take the last one
...
output_path = r"E:\Giza Systems\Mariam_Ashraf\pythonProject\M_Ashraf_model_performance_report_1000row2.xlsx"
